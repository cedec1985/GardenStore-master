...
@NgModule({
  ...
  imports: [AppComponent,NavbarComponent, HomeComponent,ReactiveFormsModule,FormsModule,ProfiluserRoutingModule,CommonModule,RouterModule,BrowserAnimationsModule,TableModule,HttpClient,
