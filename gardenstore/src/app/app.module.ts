...
@NgModule({
  ...
  imports: [CommonModule,AppComponent,NavbarComponent, HomeComponent,ProfiluserModule, FormsModule, ReactiveFormsModule, HttpClient, RouterModule,
  ...
  exports: [TableModule,HomeComponent,AppComponent,NavbarComponent,RegisterComponent,FormsModule, ReactiveFormsModule,StockEpuiseDirective,
